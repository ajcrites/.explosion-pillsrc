...
let g:pdv_cfg_Author = "Mason Malone <mason@gleim.com>"
let g:pdv_cfg_Copyright = "Copyright 2006 by Gleim Publications, Inc. and/or Gleim Internet, Inc. All worldwide rights reserved."
" let g:pdv_cfg_License = "PROPRIETARY RIGHTS NOTICE\n * This material contains valuable proprietary and trade secret information of Gleim Publications, \n * Inc. and/or Gleim Internet, Inc. of Gainesville, Florida. Except in the furtherance of the \n * business activities of Gleim Publications, Inc., and Gleim Internet, Inc., no part of such \n * information may be disclosed,  used, reproduced or transmitted in any form or by any means - \n * electronic, mechanical, optical or otherwise including photocopying and recording in connection \n * with any processing, storage or retrieval system - without prior written permission from Gleim \n * Publications, Inc or Gleim Internet, Inc."
